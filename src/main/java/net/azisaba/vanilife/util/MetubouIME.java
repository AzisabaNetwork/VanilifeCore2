...
public class MetubouIME
{
    ...
    static
    {
        ...
        MetubouIME.register("fa", "ふぁ");
        MetubouIME.register("fi", "ふぃ");
        MetubouIME.register("fo", "ふぉ");
        ...
        MetubouIME.register("kka", "っか");
        MetubouIME.register("kku", "っく");
        MetubouIME.register("kko", "っこ");
        MetubouIME.register("gya", "ぎゃ");
        MetubouIME.register("gyo", "ぎょ");
        MetubouIME.register("sya", "しゃ");
        MetubouIME.register("syo", "しょ");
        MetubouIME.register("ppu", "っぷ");
        MetubouIME.register("ppo", "っぽ");
        MetubouIME.register("wi", "うぃ");
        MetubouIME.register("we", "うぇ");
        MetubouIME.register("rya", "りゃ");
        MetubouIME.register("ryu", "りゅ");
        MetubouIME.register("ryo", "りょ");
        ...
        MetubouIME.register("syo", "しょ");
        MetubouIME.register("kya", "きゃ");
        MetubouIME.register("kyu", "きゅ");
        MetubouIME.register("kyo", "きょ");
        MetubouIME.register("nya", "にゃ");
        MetubouIME.register("nyu", "にゅ");
        MetubouIME.register("nyo", "にょ");
        MetubouIME.register("hya", "ひゃ");
        MetubouIME.register("hyu","ひゅ");
        MetubouIME.register("hyo", "ひょ");
        MetubouIME.register("ja", "じゃ");
        MetubouIME.register("jya", "じゃ");
        MetubouIME.register("ju", "じゅ");
        MetubouIME.register("jyu", "じゅ");
        MetubouIME.register("jo", "じょ");
        MetubouIME.register("jyo", "じょ");
        MetubouIME.register("!", "！");
        MetubouIME.register("?", "？");
        MetubouIME.register("[", "「");
        MetubouIME.register("]", "」");
